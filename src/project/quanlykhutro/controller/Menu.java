...
public class Menu {
    ...
    public static void menuQuanLyKhuTro() {
        ...
        System.out.println("| 4. Quản lý chuyển, trả phòng                      |");
    ...
    public static void menuQuanLyPhong() {
        ...
        System.out.println("| 4. Thống kê phòng trống                           |");
        System.out.println("| 5. Tìm kiếm phòng                                 |");
        System.out.println("| 6. Xem danh sách phòng                            |");
        System.out.println("| 0. Thoát                                          |");
        System.out.println("+---------------------------------------------------+");
    }
    ...
    public static void menuQuanLyNguoiThue() {
        ...
        System.out.println("| 4. Tìm kiếm người thuê                            |");
        System.out.println("| 5. Hiển thị danh sách người thuê                  |");
        System.out.println("| 0. Thoát                                          |");
        System.out.println("+---------------------------------------------------+");
    }
    ...
    public static void menuQuanLyHoaDon() {
        ...
        System.out.println("| 4. Thống kê công nợ                               |");
        System.out.println("| 0. Quay lại                                       |");
        System.out.println("+---------------------------------------------------+");
    }
}
